...
// Convertir "Mathematique" en "Matematika" pour correspondre aux données existantes
...
<head>
    ...
    <title>Mpitantana ny Naoty - <?php echo htmlspecialchars($anarana_feno); ?></title>
...
<body>
    <div class="container">
        ...
        <div id="seho-kilasy">
            <div class="lohateny-pejy">
                <h2>
                    ...
                    Mpitantana ny Naoty - <?php echo htmlspecialchars($taranja_mpampianatra); ?>
                </h2>
                <p>Safidio kilasy iray hitantanana ny naoty</p>
            </div>
            ...
            <?php if (empty($kilasy_rehetra)): ?>
                <div class="karatra">
                    <div class="empty-state">
                        ...
                        <h4>Tsy misy naoty hita</h4>
                        <p>Tsy misy naoty hita ho an'ity taranja ity.</p>
                    </div>
                </div>
            <?php else: ?>
                        ...
                        <div class="karatra-kilasy" onclick="ampidiro_antsipiriany_kilasy('<?php echo htmlspecialchars($kilasy['kilasy']); ?>')">
                            ...
                            <div class="statistika-kilasy">
                                <div class="singa-statistika">
                                    ...
                                    <span><?php echo $kilasy['isan_mpianatra']; ?> mpianatra</span>
                                </div>
                                <div class="singa-statistika">
                                    <i class="fas fa-chart-line"></i>
                                    <span>Salan-isa: <?php echo $kilasy['salan_isa']; ?>/20</span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
        ...
        <div id="seho-antsipiriany-kilasy" class="seho-antsipiriany-kilasy" style="display: none;">
                ...
                <div class="lohateny-kilasy-title">
                    ...
                    <div class="famintinana-kilasy">
                        <div class="singa-famintinana">
                            <i class="fas fa-user-graduate"></i>
                            <span id="isan-mpianatra-kilasy">0 mpianatra</span>
                        </div>
                        <div class="singa-famintinana">
                            <i class="fas fa-chart-line"></i>
                            <span id="salan-isa-kilasy">Salan-isa: 0/20</span>
                        </div>
                        <div class="singa-famintinana">
            ...
            <div class="fitoerana-mpianatra" id="fitoerana-mpianatra">
                <!-- Ny naoty ny mpianatra dia ho ampidirina eto amin'ny JavaScript -->
            </div>
        </div>
    </div>
    ...
    <div id="modal-fafana" class="modal" style="display: none;">
        <div class="votoaty-modal">
            ...
            <div class="votoaty-modal-body">
                <p>Tena hofafana ve ity naoty ity?</p>
                <div class="fampahalalana-naoty-modal" id="antsipiriany-naoty">
                    <!-- Antsipiriany ny naoty hofafana -->
                </div>
            </div>
    ...
    <script src="mpitantana_naoty.js"></script>
</body>
</html>
